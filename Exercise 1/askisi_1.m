...
figure
hold on
plot(t(1:100),sin(18*pi*t(1:100)')-x_analog1(1:100)) % Plot sinc Error
plot(t(1:100),sin(18*pi*t(1:100)')-x_analog2(1:100)) % Plot triangular Error
plot(t(1:100),sin(18*pi*t(1:100)')-x_analog3(1:100)) % Plot rectangular Error
hold off
